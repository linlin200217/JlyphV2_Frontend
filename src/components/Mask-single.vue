<template>
    <div class="flex flex-col flex-nowrap justify-between m-4 w-40">
        <div class="w-full h-3/4 relative">
            <button class="btn btn-circle btn-xs btn-ghost absolute bottom-2 right-1 text-dark-green"
                @click="refreshMask">
            ...
            <button class="btn btn-circle btn-xs btn-ghost btn-outline absolute top-1 right-1 text-dark-green"
                @click="removeMask">
...
const removeMask = () => {
    ...
    select_cat.value = "Categorical"
    select_num.value = "Numerical"
}
